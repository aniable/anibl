...
interface AuthController {
	...
	fun register(payload: AuthPayload.UsernamePassword): ResponseEntity<UserWithTokenDto>
	fun login(payload: AuthPayload.UsernamePassword): ResponseEntity<UserWithTokenDto>
