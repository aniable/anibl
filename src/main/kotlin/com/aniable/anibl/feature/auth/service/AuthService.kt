...
interface AuthService {
	...
	fun register(payload: AuthPayload.UsernamePassword): Result<UserWithTokenDto, AuthError>
	fun login(payload: AuthPayload.UsernamePassword): Result<UserWithTokenDto, AuthError>
}
